...
I remember fondly the moment when I have learnt about Aristotelian "essence" of entities, as a set of properties without which the entity loses its identity. Studying entropy afterwards taught me, in the same spirit, that the amount and structure of this "essence" might be quantified by the **information** contained in it. "Information" though was a mysterious concept to me, difficult to be connected to physical **matter**. Ugh, at that stage things seemed too nebulous to me. But then there was quantum. I learnt that deriving "it from qubit" recenly became a concrete research effort through study of "highly" entangled quantum many-body systems.
