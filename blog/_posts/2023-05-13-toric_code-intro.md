...
[^8]: One might also create *closed* Pauli strings (i.e. those forming topologically trivial or non-trivial *loops*). Those, as we will discuss in sections on <a href="#long-range-entanglement">long-range entanglement</a> and <a href="##loop-excitations-and-error-correction">loop excitations</a> cost no energy at all! 
...
Obviously, there is still so much to say about the toric code! If this post still leaves you hungry for more stuff on the toric code (and beyond) see the FAQ section below with further reading suggestions, have a read of the [complimentary post](https://arthurpesah.me/blog/2023-05-08-surface-code/), and stay tuned for future blogposts on related topics!
