...
To realize (i), for convenience, let’s work in the computational[^3] basis and pick the sum over $$B_p$$ operators. Undoubtedly all $$\ket 0$$ is one of the states which will be both an eigenstate (we are in Pauli Z basis)
